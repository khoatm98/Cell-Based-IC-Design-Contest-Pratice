...
vcs -full64 -R -sverilog tb.sv LASER.v +v2k  -debug_access+all +define+P2+USECOLOR +vcs+fsdbon +fsdb+mda +fsdbfile+LASER.fsdb | tee sim.log
#RTL simulation, all pattern
#vcs -full64 -R -sverilog tb.sv LASER.v +define+USECOLOR +access+r +vcs+fsdbon +fsdb+mda +fsdbfile+LASER.fsdb 
