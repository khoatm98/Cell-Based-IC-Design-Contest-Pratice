...
extern "C" {
#endif
void  rmaPropagate0_p_simv_daidir (UB  * pcode, vec32  * I1100, U  I975);
void  rmaPropagate0_simv_daidir (UB  * pcode, vec32  * I1100, U  I975);
void  rmaPropagate0_lbs_simv_daidir (UB  * pcode, scalar  val, U  I1130);
void  rmaPropagate0_lps_simv_daidir (UB  * pcode, vec32  * I1501, U  I1130, U  I1511);
void  rmaPropagate0_s0f_simv_daidir (UB  * pcode, vec32  * I1100);
void  rmaPropagate1_simv_daidir (UB  * pcode, vec32  * I1100, U  I975);
void  rmaPropagate2_p_simv_daidir (UB  * pcode, vec32  * I1100, U  I975);
void  rmaPropagate2_simv_daidir (UB  * pcode, vec32  * I1100, U  I975);
void  rmaPropagate2_lbs_simv_daidir (UB  * pcode, scalar  val, U  I1130);
void  rmaPropagate2_lps_simv_daidir (UB  * pcode, vec32  * I1501, U  I1130, U  I1511);
void  rmaPropagate2_s0f_simv_daidir (UB  * pcode, vec32  * I1100);
